    ...
    render() {
        return (
            <div className="jumbotron">
                <h1 className="text-center">Delete car</h1>
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className="input-group">
                        <div className="custom-file">
                            <input type="file" className="custom-file-input" id="image" name="image" readOnly />
                    ...
                    <select name="country" className="custom-select" id="country" readOnly>
                    ...
                    <button type="submit"
                            ...
                            disabled={this.state.loading}
                    >{this.state.loading ? 'please wait...' : 'Delete'}</button>
                </form>
            </div>
        )
    }
